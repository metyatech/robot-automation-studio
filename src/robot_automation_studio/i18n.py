...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "app.menubar.file": {"en": "File", "ja": "ファイル"},
    "app.menubar.edit": {"en": "Edit", "ja": "編集"},
    "app.menubar.run": {"en": "Run", "ja": "実行"},
    "app.menubar.tools": {"en": "Tools", "ja": "ツール"},
    "app.menubar.help": {"en": "Help", "ja": "ヘルプ"},
    "app.menu.file.exit": {"en": "Exit", "ja": "終了"},
    "app.menu.edit.add_step": {"en": "Add Step", "ja": "ステップ追加"},
    "app.menu.edit.delete": {"en": "Delete", "ja": "削除"},
    "app.menu.edit.move_up": {"en": "Move Up", "ja": "上へ移動"},
    "app.menu.edit.move_down": {"en": "Move Down", "ja": "下へ移動"},
    "app.menu.edit.duplicate": {"en": "Duplicate", "ja": "複製"},
    "app.menu.run.record": {"en": "Record", "ja": "記録開始"},
    "app.menu.run.stop_recording": {"en": "Stop Recording", "ja": "記録停止"},
    "app.menu.run.run_robot": {"en": "Run Robot", "ja": "Robot 実行"},
    "app.menu.run.stop_robot": {"en": "Stop Robot", "ja": "Robot 停止"},
    "app.menu.tools.hotkey_settings": {"en": "Hotkey Settings...", "ja": "ホットキー設定..."},
    "app.menu.tools.language": {"en": "Language", "ja": "言語"},
    "app.statusbar.stop_hotkey": {"en": "Stop: {hotkey}", "ja": "停止: {hotkey}"},
    ...
    "app.tooltip.subflow_timeout": {
        "en": "Timeout for run_subflow/parallel waits. Use 1..86400, blank, or ${variable}.",
        "ja": "run_subflow/parallel 待機のタイムアウト。1..86400、空欄、${変数} を指定できます。",
    },
